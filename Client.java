...
import java.net.*;
import java.io.*;
class ClientBox implements ActionListener
{
JTextArea status;
JFrame f;
JLabel l1 ,l2,l3;
...
Font normal1=new
Font(Font.MONOSPACED,Font.PLAIN,30);
l2 = new JLabel("Client Side");
...
Font normal2=new
Font(Font.MONOSPACED,Font.PLAIN,21);
